...
var operationRolesBearerAuth = map[string][]string{
	AuthOpsGetMeOperation:       []string{},
	PriorityOpsCreateOperation:  []string{},
	PriorityOpsDeleteOperation:  []string{},
	PriorityOpsListOperation:    []string{},
	PriorityOpsUpdateOperation:  []string{},
	StatusOpsCreateOperation:    []string{},
	StatusOpsDeleteOperation:    []string{},
	StatusOpsListOperation:      []string{},
	StatusOpsUpdateOperation:    []string{},
	TagOpsCreateOperation:       []string{},
	TagOpsDeleteOperation:       []string{},
	TagOpsListOperation:         []string{},
	TagOpsUpdateOperation:       []string{},
	TaskOpsCreateOperation:      []string{},
	TaskOpsDeleteOperation:      []string{},
	TaskOpsGetOperation:         []string{},
	TaskOpsListOperation:        []string{},
	TaskOpsUpdateOperation:      []string{},
	WishLabelOpsCreateOperation: []string{},
